...
function Signup() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const res = await axios.post(`http://localhost:8100/users/register`, data, {
                headers: {
        ...
        <div className='min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900'>
            <div className='bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md'>
                <div className='text-center '>
                    ...
                    <p className='text-gray-600 dark:text-gray-400 mt-5'>Sign up to get started</p>
                </div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='mt-4'>
                        <label className='block text-sm text-gray-500 dark:text-gray-400'>Gender</label>
                        <div className='flex items-center mt-2'>
                            <input
                                ...
                                className='mr-2'
                            />
                            <label htmlFor='male' className='mr-4 text-gray-900 dark:text-white'>Male</label>
                            <input
                                {...register("gender", { required: "Gender is required" })}
                                type='radio'
                                id='female'
